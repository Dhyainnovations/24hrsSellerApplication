...
Tab3Page.propDecorators = {
    catSelect: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: ['catSelect',] }],
    subSelect: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: ['subSelect',] }]
};
